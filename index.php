...
else
{
    ...
    $facebook_login_url = $facebook_helper->getLoginUrl('https://donantonio.herokuapp.com/');

    $facebook_login_url = '<nav class="navbar navbar-expand-md navbar-dark bg-dark sticky-top" >
    <div class="container-fluid">
        ...
        <div>
        <a href="'.$facebook_login_url.'" class="button">Connect with us</a>
        </div>
    </div>
    </nav>';
}
